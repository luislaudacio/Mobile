...
class AdapterMConta(var contexto:Context, var listaImagens:List<ImageItem>):RecyclerView.Adapter<AdapterMConta.MeuViewHolder> () {
    ...
    override fun onBindViewHolder(holder: MeuViewHolder, position: Int) {
        ...
        Glide.with(contexto)
            .load(imageItem.imageUrl) // Substitua "imageUrl" pela propriedade real em sua classe ImageItem
